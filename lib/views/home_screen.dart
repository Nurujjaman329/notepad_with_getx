...
class _HomeScreenState extends State<HomeScreen> {
            ...
            if (isSelecting.value) {
              return Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: selectedNotes.isEmpty && selectedBajarLists.isEmpty
                        ? null
                        : () {
              ...
              return IconButton(
                ...
                onPressed: () {
                  ...
                  selectedBajarLists.addAll(List.generate(bajarListController.bajarLists.length, (index) => index));
                },
              );
            }
          })
  ...
  void toggleNoteSelection(String noteId) {
    ...
    if (selectedNotes.isEmpty && selectedBajarLists.isEmpty) isSelecting.value = false;
  }
          ...
          TextButton(
            onPressed: () {
              ...
              if (selectedBajarLists.isNotEmpty) {
                ...
                final indexes = selectedBajarLists.toList()..sort((a,b) => b.compareTo(a));
